...
L<plenv|https://github.com/tokuhirom/plenv> 또는 L<perlbrew|http://perlbrew.pl/>를 사용하시거나 L<local::lib|https://metacpan.org/pod/local::lib>를 설정하시면 system-wide로 설치하지 않으셔도 됩니다.
...
또는, 다른 위치에 저장하신 후 DEVIEWSCHED_BACKEND_CONF 환경 변수를 지정합니다.
